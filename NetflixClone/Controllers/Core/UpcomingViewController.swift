...
class UpcomingViewController: UIViewController {
    ...
    private func fetchUpcoming() {
        ApiCaller.shared.getUpcomingMovies { [weak self] result in // weak self will avoid memory leaks
            switch result {
            case .success(let titles):
                self?.titles = titles
                DispatchQueue.main.async { // inside this block will be executed outside of main thread
